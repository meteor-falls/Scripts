...
({
	...
	init: function () {
		...
		emoteFormat = function (message) {
			...
			message = message.replace(/XD/g, function ($1) {
				if (emotes > 3) {
					return $1;
				}
				emotes++;
			...
			message = message.replace(/bush1/gi, function ($1) {
				if (emotes > 3) {
					return $1;
				}
				emotes++;
			...
			message = message.replace(/tface/gi, function ($1) {
				if (emotes > 3) {
					return $1;
				}
				emotes++;
			...
			message = message.replace(/:yes:/gi, function ($1) {
				if (emotes > 3) {
					return $1;
				}
				emotes++;
			...
			message = message.replace(/:no:/gi, function ($1) {
				if (emotes > 3) {
					return $1;
				}
				emotes++;
			...
			message = message.replace(/yay1/gi, function ($1) {
				if (emotes > 3) {
					return $1;
				}
				emotes++;
			...
			message = message.replace(/fyeah/gi, function ($1) {
				if (emotes > 3) {
					return $1;
				}
				emotes++;
			...
			message = message.replace(/ob1|obyds/gi, function ($1) {
				if (emotes > 3) {
					return $1;
				}
				emotes++;
	...
	beforeChatMessage: function (src, message, chan) {
		...
		loadCommandLists: function () { /* Function for building them. Don't touch unless if you want to change the layout. */
			...
			Emotes.add(":nb:");
			Emotes.add("bush1");
            Emotes.add("mitt1 | mittlol");
            Emotes.add("gates1 | gateslol");
			Emotes.add("ob1 | obyds");
            Emotes.add("pface");
			Emotes.add("feelsgd");
			Emotes.add("feelscr");
			Emotes.add("feelsrs");
